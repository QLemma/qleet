...
from .circuits.maxcut import QAOAProblem


if __name__ == '__main__':
    pass
    # x = QAOAProblem(QAOACircuitMaxCut.generate_random_graph(8), 1)
    # grid_size = 2  # Set the grid size = number of points in the interval [0, 2π).
